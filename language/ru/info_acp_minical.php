...
$lang = array_merge($lang, array(
	...
	'ACP_MINICAL_ANOUNCE_EXPLAIN'	=> 'Здесь вы можете получить информацию о неистекших событиях и удалить их, если это необходимо. Задержанные анонсы отмечены цветом.',
